...
export class Offender {
  ...
  @Field(() => Date, { description: 'Date and time the offenders was created', nullable: false })
  created_at: Date;

  @Field(() => Date, { description: 'Date and time the offenders was updated', nullable: true })
  updated_at?: Date;
}
